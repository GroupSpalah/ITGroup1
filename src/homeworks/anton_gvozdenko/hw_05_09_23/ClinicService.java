...
public class ClinicService {
    public static void main(String[] args) {
        ...
        Visit visit = new Visit(new Patient("John", 123), LocalDate.of(2023, Month.AUGUST, 2), ProcedureType.X_RAY_PROCEDURE);
